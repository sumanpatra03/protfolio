      ...
      <section className="  bg-black text-white py-10 px-4 md:px-16" id="about">
        <div className="max-w-3xl ml-25  mt-5">
          ...
          <p className="text-gray-300 text-lg leading-relaxed">
            ...
            , and UI/UX design. With expertise in building dynamic and
            responsive web applications, I focus on creating high-performance
            and user-friendly experiences. I have worked on various projects,
            including **e-commerce platforms**, **portfolio websites**, and
            **interactive dashboards**. I strive to bring innovative solutions
            and pixel-perfect designs to every project.
          </p>
