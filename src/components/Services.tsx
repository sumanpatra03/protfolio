...
import { servicesSchema } from "@/utils/schemas";
...
const services = [
  {
    ...
    glow: "group-hover:shadow-[0_0_35px_rgba(6,182,212,0.35)] group-hover:border-cyan-500/50",
  },
  {
    ...
    glow: "group-hover:shadow-[0_0_35px_rgba(139,92,246,0.35)] group-hover:border-violet-500/50",
  },
  {
    ...
    glow: "group-hover:shadow-[0_0_35px_rgba(234,179,8,0.35)] group-hover:border-yellow-500/50",
  },
];
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {services.map((service, index) => (
              <motion.div
                ...
                className="h-full"
              >
                <SpotlightCard className={`p-6 h-full flex flex-col justify-between items-center text-center transition-all duration-300 hover:bg-zinc-900/60 ${service.glow}`}>
